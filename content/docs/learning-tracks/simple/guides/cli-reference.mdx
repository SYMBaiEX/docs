...
title: "CLI Reference"
description:
  "Complete command reference for ElizaOS CLI v1.2.0 with all available commands, options, and usage
  examples"
---

# CLI Reference

Complete reference for the ElizaOS CLI (`elizaos`) v1.2.0 with all available commands, options, and
usage examples.
