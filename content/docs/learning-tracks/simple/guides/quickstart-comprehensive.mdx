...
description: "Complete beginner's guide to getting started with ElizaOS, from installation to deployment"
---
...
**Best for:** Single agent, quick deployment, learning
**Time:** 5-10 minutes

### 🔧 Path 2: Plugin Development  
**Best for:** Building reusable components, extending ElizaOS
**Time:** 15-20 minutes

### 🏗️ Path 3: Monorepo Development
**Best for:** Multiple agents, core contributions, advanced features
**Time:** 30+ minutes
