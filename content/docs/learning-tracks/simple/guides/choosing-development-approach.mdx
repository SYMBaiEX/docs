...
- **For Standalone**: Check out our [Quick Start Guide](/docs/learning-tracks/simple/getting-started/quick-start)
- **For Monorepo**: Read the [Technical Architecture Overview](/docs/learning-tracks/technical/architecture/overview)
