...
The Simple Track is designed for creators who want to deploy AI agents without coding. This track will get you from zero to a deployed AI agent in just a few minutes.
...
Jump into the [Quick Start Guide](./getting-started/quick-start) to create your first agent in 5 minutes!
