...
Submits a processed message from an agent or system component. Used for agent responses and system-generated messages.
...
**Parameters:**
- `serverId` (UUID) - Server identifier (use `00000000-0000-0000-0000-000000000000` for default server)
