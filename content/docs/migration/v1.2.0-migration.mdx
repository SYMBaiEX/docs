...
description: "Complete guide for migrating from previous versions to ElizaOS v1.2.0, including breaking changes, step-by-step instructions, and automated migration tools"
---
...
import { TestSuite, TestCase } from "@elizaos/core";
...
- [Character Definition](/docs/core-concepts/agent-development/character-definition) - Character schema documentation
...
For additional help with migration, consult the [troubleshooting guide](/docs/learning-tracks/simple/guides/troubleshooting-guide) or reach out to the ElizaOS community.