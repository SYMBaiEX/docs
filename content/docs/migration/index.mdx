...
This section contains guides for migrating between different versions of elizaOS, including API
changes, breaking changes, and upgrade paths.

## Available Migration Guides

- [ElizaOS v1.2.0 Migration Guide](/docs/migration/v1.2.0-migration) - **Complete upgrade guide**
  for migrating to v1.2.0 with breaking changes, automated tools, and step-by-step instructions
- [Migration Helper Scripts](/docs/migration/migration-helper) - Ready-to-use scripts to automate
  common migration tasks
- [API Migration Guide](/docs/migration/api-migration) - Migrate from old agent-specific APIs to the
