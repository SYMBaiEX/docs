...
description: Guide for migrating from old agent-specific APIs to the new centralized messaging system
---
...
1. Review the [Message Bus Architecture](/docs/core-concepts/communication/message-bus) to understand the new system
2. Explore [WebSocket documentation](/docs/core-concepts/communication/websockets) for real-time features
3. Check the [REST API reference](/docs/core-concepts/communication/rest-api) for additional endpoints
