...
Set a default provider for all model types:

```typescript
{
  "name": "MyAgent",
  "modelProvider": "openai",  // Primary provider
  "plugins": ["@elizaos/plugin-openai"]
}
```
...
{
  "name": "MyAgent",
  "modelProvider": "anthropic",  // Primary for text generation
  "plugins": [
    "@elizaos/plugin-anthropic",  // Primary text generation
