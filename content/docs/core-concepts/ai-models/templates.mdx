...
const twitterTemplates = {
  // Tweet generation
  twitterPostTemplate: `
    Generate a tweet as {{characterName}}.
    
    Character: {{bio}}
    Topics: {{topics}}
    Style: {{style}}
    
    Recent tweets: {{recentPosts}}
  ...
  twitterMessageHandlerTemplate: `
    You are {{characterName}} responding to a tweet.
    
    Original tweet: {{message}}
    Context: {{context}}
    
    Write a brief, engaging response:
  `,
  
  // Twitter engagement decision
  twitterShouldRespondTemplate: `
    Should {{characterName}} respond to this tweet?
    
    Tweet: {{message}}
    Author: {{senderName}}
    
    Consider engagement value. YES/NO:
  `
};
```
...
const discordTemplates = {
  ...
  discordMessageHandlerTemplate: `
    You are {{characterName}} in Discord server "{{serverName}}".
  ...
  discordAutoPostTemplate: `
    Create an engaging post for Discord channel "{{channelName}}".
    
    Character: {{characterName}}
    Server activity: {{serverActivity}}
    
    Write something relevant and interesting:
  `
};
```
...
const telegramTemplates = {
  ...
  telegramMessageHandlerTemplate: `
    You are {{characterName}} in Telegram chat.
  ...
  telegramAutoPostTemplate: `
    Create a post for Telegram channel "{{channelName}}".
