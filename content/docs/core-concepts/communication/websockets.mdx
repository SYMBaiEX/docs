---
title: WebSockets
description: Real-time communication with WebSocket implementation in elizaOS
---

# WebSockets

elizaOS provides real-time communication capabilities through WebSocket connections, enabling instant message delivery, channel management, and live system monitoring. The WebSocket implementation is built on Socket.IO and integrated with the central message bus.
...
// WebSocket server is automatically created
