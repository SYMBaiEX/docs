...
This section provides comprehensive guides for different development workflows and approaches when working with Eliza.
...
<Callout type="info">
  **New to Eliza?** Start with [Standalone vs Monorepo](/guides/standalone-vs-monorepo) to understand your options.
</Callout>
