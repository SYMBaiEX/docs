...
<Callout type="info">
**Unified Processing**: All client types feed messages into the same processing pipeline. The `processMessage` function handles messages identically regardless of their origin - Discord, Twitter, REST API, or any other client.
</Callout>
