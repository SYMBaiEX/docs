...
<Tabs items={['Project', 'Plugin', 'Agent', 'TEE']}>
  <Tab value="Project">
    **Full ElizaOS Application**
    
    - Complete agent framework with all features
    ...
    **Use when**: Building a complete AI agent application
  </Tab>
  <Tab value="Plugin">
    **Plugin Development**
    ...
    - Action, provider, and evaluator development
    ...
    **Use when**: Creating extensions for ElizaOS
  </Tab>
  <Tab value="Agent">
    ...
    **Use when**: Defining agent personalities and behaviors
  </Tab>
  <Tab value="TEE">
    **Trusted Execution Environment**
    
    - Secure, decentralized agent deployment
    ...
    **Use when**: Deploying secure, decentralized agents
  </Tab>
</Tabs>
...
<Tabs items={['Communication', 'AI Models', 'Blockchain', 'Utilities']}>
  <Tab value="Communication">
    **Platform Integrations**
    ...
    - `@elizaos/plugin-discord` - Discord bot functionality
    - `@elizaos/plugin-telegram` - Telegram integration
    - `@elizaos/plugin-twitter` - Twitter/X platform
    - `@elizaos/plugin-slack` - Slack workspace integration
    
    **When to use**: Connect your agent to messaging platforms
  </Tab>
  <Tab value="AI Models">
    **Model Providers**
    ...
    - `@elizaos/plugin-google` - Google AI models
    - `@elizaos/plugin-ollama` - Local model support
    
    **When to use**: Integrate different AI model providers
  </Tab>
  <Tab value="Blockchain">
    **Blockchain Integrations**
    
    - `@elizaos/plugin-ethereum` - Ethereum blockchain
    - `@elizaos/plugin-solana` - Solana blockchain
    - `@elizaos/plugin-defi` - DeFi protocols
    - `@elizaos/plugin-nft` - NFT marketplace integration
    
    **When to use**: Build blockchain-enabled agents
  </Tab>
  <Tab value="Utilities">
    **Utility Plugins**
    
    - `@elizaos/plugin-image` - Image generation and processing
    - `@elizaos/plugin-search` - Web search capabilities
    - `@elizaos/plugin-calendar` - Calendar and scheduling
    - `@elizaos/plugin-files` - File system operations
    
    **When to use**: Add specific functionality to your agent
  </Tab>
</Tabs>
...
- **Troubleshooting Guide**: [Full troubleshooting guide](/docs/learning-tracks/simple/guides/troubleshooting-guide)
