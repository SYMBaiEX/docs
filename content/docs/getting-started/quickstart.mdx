...
<Callout type="info">
Complete installation instructions are available in the [Installation Guide](/docs/getting-started/installation).
</Callout>
...
<Cards>
  ...
  <Card title="Customize Personality" href="/docs/core-concepts/agent-development/character-definition" icon="🎭">
...
- **Troubleshooting Guide**: [Check our comprehensive guide](/docs/learning-tracks/simple/guides/troubleshooting-guide)
...
Explore the [configuration guide](/docs/getting-started/configuration) to learn about advanced features, or dive into [plugin development](/docs/plugins/creating-plugins) to extend your agent's capabilities.