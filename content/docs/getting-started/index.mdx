...
<Steps>
  ...
  <Step>
    ...
    Install from [bun.sh](https://bun.sh/docs/installation) - v1.2.15 or higher recommended
  </Step>
  <Step>
...
ElizaOS supports different project types for various use cases:
...
- **Database connection errors**: Check your database URL in `.env` or switch to `pglite` for
  development
- **Windows users**: Must use WSL 2, native Windows installation is not supported
