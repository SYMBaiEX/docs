...
<Callout type="info">
ElizaOS v1.2.0 requires Node.js v23.3.0 (exact version) and Bun v1.2.15 for optimal compatibility and performance.
</Callout>

## System Requirements

<Cards>
  <Card title="Operating System" icon={<FileIcon />}>
  ...
  <Card title="Hardware Requirements" icon={<CpuIcon />}>
    - **Memory**: Minimum 4GB RAM (8GB+ recommended)
    - **Storage**: At least 2GB free disk space
    - **CPU**: Modern multi-core processor recommended
  </Card>
  <Card title="Network Requirements" icon={<NetworkIcon />}>
...
# Bootstrap behavior
# Set to true to skip bootstrap plugin (not recommended)
...
#### Windows (WSL2) Issues
- **WSL 2 not installed**: Run `wsl --install` in PowerShell as Administrator
