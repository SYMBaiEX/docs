...
The Eliza Desktop application provides a native desktop experience for running and interacting with Eliza agents. Built with [Tauri](https://tauri.app/), it combines a React frontend with a lightweight Rust backend for optimal performance and security.
