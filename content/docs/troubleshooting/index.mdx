...
eliza doctor
```
This command checks your ElizaOS installation for common issues.
</Step>
...
## Test Configuration
```bash
eliza validate --config ./eliza.config.js
```
Validates your configuration file for syntax and schema errors.
</Step>
</Steps>
