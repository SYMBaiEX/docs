...
This guide shows you how to quickly create new plugins for elizaOS using the CLI tools. For detailed
information about plugin architecture and components, see the
...
For more information about plugin development, including detailed API references and best practices,
see the [Plugin System Architecture](/docs/core-concepts/architecture/plugin-system) documentation.
