...
ElizaOS plugins extend the capabilities of your agents with custom actions, providers, services, and
more. The plugin system provides a comprehensive framework for building and distributing
reusable functionality.

The plugin ecosystem includes a growing collection of available plugins across various categories, from core
functionality to specialized integrations, making it easy to extend your agents with powerful
capabilities.
...
Explore plugins in the [Plugin Registry](/docs/plugins/plugin-registry) or manage them via CLI:
...
- [Plugin Registry](/docs/plugins/plugin-registry) - Complete catalog of available plugins
- [Plugin Templates](/docs/plugins/plugin-templates) - Ready-to-use templates and examples
- [Plugin Testing](/docs/plugins/plugin-testing) - Comprehensive testing strategies
- [Plugin Development & Linking](/docs/guides/plugin-development-linking) - Advanced development
  workflows
