...
more. The plugin system in v1.2.0 provides a comprehensive framework for building and distributing
reusable functionality.

The plugin ecosystem includes 130+ available plugins across various categories, from core
